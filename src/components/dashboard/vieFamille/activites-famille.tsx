...
interface ActivitesFamilleProps {
  activities: Activity[];
}

export default function ActivitesFamille({ activities }: ActivitesFamilleProps) {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 p-4">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-red-700">Activités en Famille en Tunisie</h1>
          <p className="text-gray-600">
            Découvrez des activités amusantes et enrichissantes à faire avec vos enfants partout en Tunisie, adaptées à
            leurs âges et à vos préférences.
          </p>
        </div>
              ...
              <div key={activity.id} className="overflow-hidden rounded-lg bg-white shadow-md">
                ...
                <div className="p-4">
                  ...
                  <div className="mb-2 text-xs text-gray-500">
                    <span>{activity.location}</span> | <span>{activity.ageRange} ans</span> |{' '}
