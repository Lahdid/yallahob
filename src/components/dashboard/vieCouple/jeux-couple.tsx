...
interface JeuxCoupleProps {
  cards: Question[];
}

export default function JeuxCouple({ cards }: JeuxCoupleProps) {
  return (
    <div className=" flex flex-col gap-4 p-6">
      <h1 className="text-2xl font-bold">Jeux de Cartes Pour Couple</h1>
      {/* Aside Section */}
