...
export const ImageExtension = Image.extend({
  ...
  renderHTML({ HTMLAttributes }) {
    ...
    return [
      ...
      {
        ...attrs,
        style: `width: ${width || '100%'}; display: block; margin: ${
        ...
        {editor?.isEditable && (
          <>
            <div
              ...
              <div className="z-20 h-[70px] w-1 rounded-xl border bg-destructive opacity-0 transition-all group-hover:opacity-100" />
            </div>
            <div
            ...
            <div
              ...
              <DropdownMenu
                ...
                <DropdownMenuContent align="start" alignOffset={-90} className="mt-1 bg-background text-sm">
                  <DropdownMenuItem
                    onClick={() => {
                  ...
                  <DropdownMenuItem
                    ...
                    <Maximize className="mr-2 size-4" /> Plein écran
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
                    ...
                    <Trash className="mr-2 size-4" /> Supprimer
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
