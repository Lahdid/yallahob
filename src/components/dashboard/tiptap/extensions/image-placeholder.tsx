  ...
  return (
    <NodeViewWrapper className="w-full">
      <Popover modal open={open}>
        ...
        <PopoverContent
          className="w-[450px] bg-background px-0 py-2"
            ...
            <TabsContent value="upload">
              <div
                ...
                <label
                  ...
                  <IconUpload className="mx-auto mb-2 h-6 w-6" />
                  Glisser et déposer
                </label>
              </div>
            </TabsContent>
            <TabsContent value="url">
              <form onSubmit={handleInsertEmbed}>
                <Input
                  ...
                  placeholder="Coller le lien de l'image"
                />
                {urlError && <p className="text-danger-11 py-1.5 text-xs">Veuillez entrer un lien valide</p>}
                <Button onClick={handleInsertEmbed} type="button" size="sm" className="my-2 h-8 w-full p-2 text-xs">
                  Insérer l'image
                </Button>
                <p className="text-gray-11 text-center text-xs">Fonctionne avec n'importe quelle image du web</p>
              </form>
            </TabsContent>
          </Tabs>
        </PopoverContent>
